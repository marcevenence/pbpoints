...
import com.pbpoints.service.EquipmentQueryService;
import com.pbpoints.service.EquipmentService;
...
/**
 * REST controller for managing {@link com.pbpoints.domain.Equipment}.
 */
@RestController
@RequestMapping("/api")
public class EquipmentResource {
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/equipment/{id}", consumes = "application/merge-patch+json")
    ...
    public ResponseEntity<List<EquipmentDTO>> getAllEquipment(EquipmentCriteria criteria) {
        log.debug("REST request to get Equipment by criteria: {}", criteria);
        List<EquipmentDTO> entityList = equipmentQueryService.findByCriteria(criteria);
