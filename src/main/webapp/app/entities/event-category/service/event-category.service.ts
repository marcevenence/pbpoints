...
export class EventCategoryService {
  ...
  count(id: number): Observable<HttpResponse<number>> {
    const options = createRequestOption({ 'eventCategoryId ': id });
    return this.http.get<number>(`api/roster/count`, { params: options, observe: 'response' });
  }
