...
describe('Component Tests', () => {
  describe('PlayerPoint Management Component', () => {
    let comp: PlayerPointComponent;
    let fixture: ComponentFixture<PlayerPointComponent>;
    let service: PlayerPointService;

    beforeEach(() => {
      TestBed.configureTestingModule({
        imports: [HttpClientTestingModule],
        declarations: [PlayerPointComponent],
      })
        .overrideTemplate(PlayerPointComponent, '')
        .compileComponents();

      fixture = TestBed.createComponent(PlayerPointComponent);
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.playerPoints[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
