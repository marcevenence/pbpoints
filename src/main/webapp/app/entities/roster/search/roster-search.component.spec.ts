...
describe('Component Tests', () => {
  describe('Roster Management Search Component', () => {
    let comp: RosterSearchComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(RosterSearchComponent, '')
        .compileComponents();
    ...
    describe('save', () => {
      it('Should call update service on save for existing entity', () => {
        ...
        const roster = { id: 123 };
        spyOn(rosterService, 'search').and.returnValue(saveSubject);
