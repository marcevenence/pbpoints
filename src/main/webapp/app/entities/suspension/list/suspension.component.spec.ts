...
describe('Component Tests', () => {
  describe('Suspension Management Component', () => {
    let comp: SuspensionComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(SuspensionComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.suspensions[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
