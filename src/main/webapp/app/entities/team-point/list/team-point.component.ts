...
export class TeamPointComponent implements OnInit {
  ...
  delete(teamPoint: ITeamPoint): void {
    const modalRef = this.modalService.open(TeamPointDeleteDialogComponent, { size: 'lg', backdrop: 'static' });
    modalRef.componentInstance.teamPoint = teamPoint;
  ...
  protected onSuccess(data: ITeamPoint[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
